...
1. Read the `ielts-speaking-part1` skill definition at `D:\programming\project-owner\dev-note\md\AI Q&A\skills\ielts-speaking-part1\SKILL.md` (once, before processing any question).
